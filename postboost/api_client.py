...
from postboost.api_response import ApiResponse, T as ApiResponseT
import postboost.models
from postboost import rest
from postboost.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(postboost.models, klass)
