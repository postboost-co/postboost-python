...
class InitiateRemoteUploadRequest(BaseModel):
    """
    InitiateRemoteUploadRequest
    """ # noqa: E501
    url: StrictStr = Field(description="URL of the remote file to download.")
    alt_text: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
