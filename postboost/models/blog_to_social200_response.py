...
class BlogToSocial200Response(BaseModel):
    """
    BlogToSocial200Response
    """ # noqa: E501
    data: Optional[BlogToSocialResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlogToSocial200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlogToSocial200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": BlogToSocialResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
