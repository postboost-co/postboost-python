...
class BlogToSocialMedia(BaseModel):
    """
    The imported featured image. Only present when `create_post` was `true` and an image was available.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Media library ID of the imported image.")
    url: Optional[StrictStr] = Field(default=None, description="Public URL of the imported image in the workspace media library.")
