...
class ImageAltTextInput(BaseModel):
    """
    ImageAltTextInput
    """ # noqa: E501
    media_uuid: StrictStr
    __properties: ClassVar[List[str]] = ["media_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageAltTextInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageAltTextInput from a dict"""
        if obj is None:
            return None
