...
class DeletePostsBulkRequest(BaseModel):
    """
    DeletePostsBulkRequest
    """ # noqa: E501
    posts: List[StrictStr] = Field(description="Array of post UUIDs to delete.")
    trash: Optional[StrictBool] = Field(default=False, description="Move to trash instead of permanent delete.")
    delete_mode: Optional[DeleteMode] = DeleteMode.APP_ONLY
    __properties: ClassVar[List[str]] = ["posts", "trash", "delete_mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "posts": obj.get("posts"),
            "trash": obj.get("trash") if obj.get("trash") is not None else False,
            "delete_mode": obj.get("delete_mode") if obj.get("delete_mode") is not None else DeleteMode.APP_ONLY
        })
        return _obj
