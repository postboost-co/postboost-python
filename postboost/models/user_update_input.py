...
class UserUpdateInput(BaseModel):
    ...
    name: StrictStr
    email: StrictStr
    password: Optional[SecretStr] = Field(default=None, description="Omit or set to null to keep the current password.")
    password_confirmation: Optional[SecretStr] = None
    is_admin: StrictBool
    __properties: ClassVar[List[str]] = ["name", "email", "password", "password_confirmation", "is_admin"]
