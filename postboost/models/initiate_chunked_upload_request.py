...
class InitiateChunkedUploadRequest(BaseModel):
    """
    InitiateChunkedUploadRequest
    """ # noqa: E501
    filename: Annotated[str, Field(strict=True, max_length=255)]
    mime_type: StrictStr
    total_size: StrictInt = Field(description="Total file size in bytes.")
    __properties: ClassVar[List[str]] = ["filename", "mime_type", "total_size"]
