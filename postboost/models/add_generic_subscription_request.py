...
class AddGenericSubscriptionRequest(BaseModel):
    """
    AddGenericSubscriptionRequest
    """ # noqa: E501
    plan_id: StrictInt
    trial_days: Optional[Annotated[int, Field(le=365, strict=True, ge=0)]] = None
    keep_prev_trial_ends_at: StrictBool
    __properties: ClassVar[List[str]] = ["plan_id", "trial_days", "keep_prev_trial_ends_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keep_prev_trial_ends_at": obj.get("keep_prev_trial_ends_at")
        })
        return _obj
