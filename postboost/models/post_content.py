...
class PostContent(BaseModel):
    ...
    PostContent
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Post text/caption.")
    url: Optional[StrictStr] = None
    media: Optional[List[StrictInt]] = Field(default=None, description="Array of media IDs from the media library.")
    video_thumbs: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["body", "url", "media", "video_thumbs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "media": obj.get("media"),
            "video_thumbs": obj.get("video_thumbs")
        })
        return _obj
