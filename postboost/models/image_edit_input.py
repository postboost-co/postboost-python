...
class ImageEditInput(BaseModel):
    ...
    ImageEditInput
    """ # noqa: E501
    media_uuid: StrictStr = Field(description="UUID of the source media item to edit")
    prompt: Annotated[str, Field(strict=True, max_length=4000)] = Field(description="Describe what to change in the image")
    mask_uuid: Optional[StrictStr] = Field(default=None, description="UUID of a mask image. Transparent areas will be edited.")
    ...
    __properties: ClassVar[List[str]] = ["media_uuid", "prompt", "mask_uuid", "aspect_ratio", "count", "quality"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "media_uuid": obj.get("media_uuid"),
            "prompt": obj.get("prompt"),
            "mask_uuid": obj.get("mask_uuid"),
