...
class SubscriptionUpdateInput(BaseModel):
    ...
    trial_ends_at: Optional[datetime] = Field(default=None, description="Required when status is `trialing`.")
    paused_from: Optional[datetime] = Field(default=None, description="Required when status is `paused`.")
    __properties: ClassVar[List[str]] = ["platform_plan_id", "status", "trial_ends_at", "paused_from"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "platform_plan_id": obj.get("platform_plan_id"),
            "status": obj.get("status"),
            "trial_ends_at": obj.get("trial_ends_at"),
            "paused_from": obj.get("paused_from")
        })
        return _obj
