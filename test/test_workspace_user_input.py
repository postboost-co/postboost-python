...
class TestWorkspaceUserInput(unittest.TestCase):
    """WorkspaceUserInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceUserInput:
        """Test WorkspaceUserInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceUserInput`
        """
        model = WorkspaceUserInput()
        if include_optional:
            return WorkspaceUserInput(
                user_id = 56,
                role = 'admin',
                can_approve = True,
                is_owner = True
    ...
    def testWorkspaceUserInput(self):
        """Test WorkspaceUserInput"""
