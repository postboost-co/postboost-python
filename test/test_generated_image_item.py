...
class TestGeneratedImageItem(unittest.TestCase):
    """GeneratedImageItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratedImageItem:
        """Test GeneratedImageItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratedImageItem`
        """
        model = GeneratedImageItem()
        if include_optional:
    ...
    def testGeneratedImageItem(self):
        """Test GeneratedImageItem"""
