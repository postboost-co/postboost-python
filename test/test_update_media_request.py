...
class TestUpdateMediaRequest(unittest.TestCase):
    """UpdateMediaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMediaRequest:
        """Test UpdateMediaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMediaRequest`
        """
    ...
    def testUpdateMediaRequest(self):
        """Test UpdateMediaRequest"""
