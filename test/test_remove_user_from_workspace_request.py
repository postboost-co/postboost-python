...
class TestRemoveUserFromWorkspaceRequest(unittest.TestCase):
    """RemoveUserFromWorkspaceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveUserFromWorkspaceRequest:
        """Test RemoveUserFromWorkspaceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveUserFromWorkspaceRequest`
        """
        model = RemoveUserFromWorkspaceRequest()
        if include_optional:
            return RemoveUserFromWorkspaceRequest(
                user_id = 56
            )
        else:
            return RemoveUserFromWorkspaceRequest(
    ...
    def testRemoveUserFromWorkspaceRequest(self):
        """Test RemoveUserFromWorkspaceRequest"""
