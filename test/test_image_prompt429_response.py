...
class TestImagePrompt429Response(unittest.TestCase):
    """ImagePrompt429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImagePrompt429Response:
        """Test ImagePrompt429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImagePrompt429Response`
        """
        model = ImagePrompt429Response()
        if include_optional:
            return ImagePrompt429Response(
                message = 'Insufficient AI credits. You need 1 credits but only have 0 remaining this month.'
            )
        else:
            return ImagePrompt429Response(
        )
    ...
    def testImagePrompt429Response(self):
        """Test ImagePrompt429Response"""
