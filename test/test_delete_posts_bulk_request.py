...
class TestDeletePostsBulkRequest(unittest.TestCase):
    """DeletePostsBulkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletePostsBulkRequest:
        """Test DeletePostsBulkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePostsBulkRequest`
        """
        model = DeletePostsBulkRequest()
        if include_optional:
            return DeletePostsBulkRequest(
                posts = [
                    ''
                    ],
                trash = True,
    ...
    def testDeletePostsBulkRequest(self):
        """Test DeletePostsBulkRequest"""
