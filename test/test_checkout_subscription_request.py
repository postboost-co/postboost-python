...
class TestCheckoutSubscriptionRequest(unittest.TestCase):
    """CheckoutSubscriptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutSubscriptionRequest:
        """Test CheckoutSubscriptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutSubscriptionRequest`
        """
        model = CheckoutSubscriptionRequest()
        if include_optional:
            return CheckoutSubscriptionRequest(
                plan_id = 56,
                cycle = 'monthly',
                coupon = ''
            )
    ...
    def testCheckoutSubscriptionRequest(self):
        """Test CheckoutSubscriptionRequest"""
