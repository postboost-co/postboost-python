...
class TestBlogToSocial429Response(unittest.TestCase):
    """BlogToSocial429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlogToSocial429Response:
        """Test BlogToSocial429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlogToSocial429Response`
        """
        model = BlogToSocial429Response()
        if include_optional:
            return BlogToSocial429Response(
                message = 'Insufficient AI credits. You need 3 credits but only have 1 remaining this month.'
            )
        else:
            return BlogToSocial429Response(
        )
    ...
    def testBlogToSocial429Response(self):
        """Test BlogToSocial429Response"""
