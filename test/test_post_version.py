...
class TestPostVersion(unittest.TestCase):
    """PostVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostVersion:
        """Test PostVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostVersion`
        """
        model = PostVersion()
        if include_optional:
            return PostVersion(
