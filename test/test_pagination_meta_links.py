...
class TestPaginationMetaLinks(unittest.TestCase):
    """PaginationMetaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationMetaLinks:
        """Test PaginationMetaLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationMetaLinks`
        """
        model = PaginationMetaLinks()
        if include_optional:
            return PaginationMetaLinks(
                first = '',
                last = '',
                prev = '',
                next = ''
    ...
    def testPaginationMetaLinks(self):
        """Test PaginationMetaLinks"""
