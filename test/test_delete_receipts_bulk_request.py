...
class TestDeleteReceiptsBulkRequest(unittest.TestCase):
    """DeleteReceiptsBulkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteReceiptsBulkRequest:
        """Test DeleteReceiptsBulkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteReceiptsBulkRequest`
        """
        model = DeleteReceiptsBulkRequest()
        if include_optional:
            return DeleteReceiptsBulkRequest(
                receipts = [
                    ''
                    ]
            )
    ...
    def testDeleteReceiptsBulkRequest(self):
        """Test DeleteReceiptsBulkRequest"""
