...
class TestCheckoutSubscription200Response(unittest.TestCase):
    """CheckoutSubscription200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutSubscription200Response:
        """Test CheckoutSubscription200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutSubscription200Response`
        """
        model = CheckoutSubscription200Response()
        if include_optional:
    ...
    def testCheckoutSubscription200Response(self):
        """Test CheckoutSubscription200Response"""
