...
class TestImageGenerateInput(unittest.TestCase):
    """ImageGenerateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageGenerateInput:
        """Test ImageGenerateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageGenerateInput`
        """
        model = ImageGenerateInput()
        if include_optional:
    ...
    def testImageGenerateInput(self):
        """Test ImageGenerateInput"""
