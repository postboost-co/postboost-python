...
class TestDeleteWorkspacesBulkRequest(unittest.TestCase):
    """DeleteWorkspacesBulkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteWorkspacesBulkRequest:
        """Test DeleteWorkspacesBulkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteWorkspacesBulkRequest`
        """
        model = DeleteWorkspacesBulkRequest()
        if include_optional:
            return DeleteWorkspacesBulkRequest(
                workspaces = [
                    ''
                    ]
            )
    ...
    def testDeleteWorkspacesBulkRequest(self):
        """Test DeleteWorkspacesBulkRequest"""
