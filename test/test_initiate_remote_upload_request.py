...
class TestInitiateRemoteUploadRequest(unittest.TestCase):
    """InitiateRemoteUploadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateRemoteUploadRequest:
        """Test InitiateRemoteUploadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateRemoteUploadRequest`
        """
        model = InitiateRemoteUploadRequest()
        if include_optional:
            return InitiateRemoteUploadRequest(
                url = '',
                alt_text = ''
            )
        else:
    ...
    def testInitiateRemoteUploadRequest(self):
        """Test InitiateRemoteUploadRequest"""
