...
class TestImageVariationsInput(unittest.TestCase):
    """ImageVariationsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageVariationsInput:
        """Test ImageVariationsInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageVariationsInput`
        """
        model = ImageVariationsInput()
        if include_optional:
            return ImageVariationsInput(
                media_uuid = '',
                aspect_ratio = '1:1',
                count = 1,
                quality = 'standard'
    ...
    def testImageVariationsInput(self):
        """Test ImageVariationsInput"""
